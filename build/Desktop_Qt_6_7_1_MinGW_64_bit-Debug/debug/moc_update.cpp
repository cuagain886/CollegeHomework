...
constexpr auto qt_meta_stringdata_CLASSupdateENDCLASS = QtMocHelpers::stringData(
    "update",
    "on_updateclassmatepushButton_clicked",
    "",
...
Q_CONSTINIT const QMetaObject update::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSupdateENDCLASS_t,
        ...
        // method 'on_updateclassmatepushButton_clicked'
...
void update::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_updateclassmatepushButton_clicked(); break;
